...
/**
 * Validation rules dictionary with fluent rule builder representation of rules.
 */
class FluentValidationRulesDictionary implements IValidationRulesDictionary
{
    /**
    ...
    {
        return '\Saritasa\Laravel\Validation\Rule::';
    }
