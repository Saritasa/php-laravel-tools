 ...
 */
class ApiRoutesGroupResourceRegistrarGenerator implements IApiRoutesGroupGenerator
{
    /**
    ...
    protected function getGroupDeclaration(string $groupContent, ?array $middleware = null): string
    {
        ...
        $resourceRegistrarDeclaration = '$registrar = new \App\Routing\ApiResourceRegistrar($api);';

        $groupContent = $this->codeFormatter->linesToBlock([$resourceRegistrarDeclaration, '', $groupContent]);
