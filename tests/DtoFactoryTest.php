...
class DtoFactoryTest extends TestCase
{
     ...
     * @param bool $withGetters Is need to generate DTO with typehinted getters
     * @param bool $withSetters Is need to generate DTO with typehinted setters
     *
    ...
    private function getDtoFactoryConfig(
        ...
        return new DtoFactoryConfig([
            ...
            DtoFactoryConfig::WITH_GETTERS => $withGetters,
            DtoFactoryConfig::WITH_SETTERS => $withSetters,
        ]);
    }
    ...
    public function dtoBuildTestDataProvider(): array
    {
        return [
            ...
            'Protected variables with getters and setters' => [
                $this->getDtoFactoryConfig(['name', 'birth_date'], PropertiesVisibilityTypes::PROTECTED, true, true),
                $this->getExpectedDtoContentWithProtectedPropertiesWithGettersAndSetters(),
            ],
        ];
    }
...
templateContent;
    ...
    /**
     * Returns template that should be generated by DTO factory with protected properties and typehinted getters and
     * setters for each attribute.
     *
     * @return string
     */
    private function getExpectedDtoContentWithProtectedPropertiesWithGettersAndSetters(): string
    {
        return <<<templateContent
<?php
